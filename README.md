...
1. What is the purpose of using _sessions_?
   ...
   > Sessions are used for tracking and storing users state between page requests.

1. What does bcrypt do to help us store passwords in a secure manner.

   > Bcrypt helps us hash passwords and in that way makes our passwords secure.

1. What does bcrypt do to slow down attackers?

   > By hashing the hash of the hashed hash a certain number of times.

1. What are the three parts of the JSON Web Token?
   > - Headers, Payload and Secret
